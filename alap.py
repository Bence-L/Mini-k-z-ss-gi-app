...
bence_valaszt = Button(master, text ="Fal", bg="#54F2F2", font="Times 30 bold",  borderwidth=20, command = nyisdmegafalat).grid(row= 4, column=1, pady=10,padx=(25, 25))
...
fal_emoji = Label(master, text="🎪", bg="black",fg="#54F2F2",font=('Times', 35))
